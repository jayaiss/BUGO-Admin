    ...
    <div class="modal-content">
      ...
      <div class="modal-body row">
        ...
        <div id="layoutSidenav" class="container-fluid">
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <!-- Encrypted Sidebar Links -->
                                 <a class="nav-link <?php echo ($page === 'admin_dashboard') ? '' : 'collapsed'; ?>" 
               href="index_Admin.php?page=<?php echo urlencode(encrypt('admin_dashboard')); ?>">
              <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div> Dashboard
            </a>
            <a class="nav-link <?php echo ($page === 'urgent_request') ? '' : 'collapsed'; ?>" 
            ...
            <a class="nav-link <?php echo ($page === 'view_appointments') ? '' : 'collapsed'; ?>" 
            ...
            <a class="nav-link <?php echo in_array($page, ['barangay_official_list','barangay_info','certificate_list','time_slot']) ? '' : 'collapsed'; ?>" 
            ...
            <div class="collapse" id="barangay_official_nav_desktop">
            ...
            <div class="collapse" id="notice_desktop">
              <nav class="sb-sidenav-menu-nested nav">
            ...
            <div class="collapse" id="audit_nav_desktop">
              <nav class="sb-sidenav-menu-nested nav">
            ...
            <a class="nav-link <?php echo ($page === 'reports') ? '' : 'collapsed'; ?>" 
            ...
            <a class="nav-link <?php echo ($page === 'archive') ? '' : 'collapsed'; ?>" 
...
if (isset($_GET['page'])) {
    ...
    if ($decrypted !== false) $decryptedPage = $decrypted;
}
