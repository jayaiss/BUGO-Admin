...
$unionSql = "
  -- 1) Urgent Cedula (highest priority)
  SELECT 
    1 AS src_priority,
    ucr.tracking_number,
  ...
  -- 4) Urgent Requests (non-cedula, or with optional cedula info)
  SELECT 
    4 AS src_priority,
    u.tracking_number,
    CONCAT(r.first_name,' ',IFNULL(r.middle_name,''),' ',r.last_name,' ',IFNULL(r.suffix_name,'')) AS fullname,
        ...
        <?php endif; ?>
                ...
                <div style="display: flex; justify-content: space-between; margin-bottom: 15px;">
                    ...
                    <section style="width: -155%; text-align: center; font-size: 20px; position: relative;">
                        ...
                        <img src="components/employee_modal/show_esignature.php?t=<?=time()?>"
        ...
        `;
            ...
            <?php endif; ?>
                        ...
                        <section style="width: -155%; text-align: center; font-size: 25px; position: relative;">
                            ...
                            ?>
                            <!-- Adjust the margin to reduce space between name and title -->
                            ...
                            <!-- e-Signature Image positioned over the name -->
                            <img src="components/employee_modal/show_esignature.php?t=<?=time()?>"
